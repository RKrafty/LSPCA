...
The dataframe `HC` provided in the package contains 64 chanell EEG recording of a Healthy Control subject collected as part of an NIH funded study (R01MH113827)). Data were collected while the participant sat in a chair and relaxed with their eyes open. The data are sampled at 64 Hz for one minutes.
